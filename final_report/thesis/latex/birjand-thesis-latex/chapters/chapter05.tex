...
سنجش زمان اجرای سیستم بر روی پلتفرم کم‌مصرف پردازش لبه \lr{NVIDIA Jetson TX2} نشان داد که زمان اجرای کل برای یک تصویر پزشکی استاندارد به \textbf{۲.۸۵ ثانیه} رسید (استنتاج \lr{U{-}Net}: ۰.۸۲ ثانیه، سیستم ۵بعدی: ۰.۴۵ ثانیه، زیگ‌زاگ و \lr{DNA}: ۰.۹۸ ثانیه، \lr{zlib/Saliency}: ۰.۶۰ ثانیه) \ThesisCite{10}, \ThesisCite{11}. در بستر سرور/کولب، زمان اجرای زنده خط لوله برای تصویر DRIVE (۵۸۴×۵۶۵) برابر با \textbf{۰.۵۸۴۶ ثانیه} ثبت شده است. تحلیل تفکیکی زمان اجرا آشکار ساخت که استنتاج شبکه عصبی عمیق \lr{U{-}Net} جهت قطعه‌بندی \lr{ROI} سهمی معادل \textbf{۰.۸۲ ثانیه (۲۸.۸\SourceGlyph{066A} از زمان کل لبه)} را به خود اختصاص داده است \ThesisCite{1}, \ThesisCite{10}. این امر نشان می‌دهد که پیاده‌سازی مدل‌های عمیق بر روی تجهیزات کم‌مصرف پوشیدنی یا حسگرهای محدود \lr{IoMT} می‌تواند با چالش مصرف انرژی و گلوگاه استنتاج مواجه گردد.\par
