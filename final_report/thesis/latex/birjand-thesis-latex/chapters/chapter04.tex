...
۱. \textbf{مجموعه‌داده \lr{DRIVE}:} آنتروپی تصویر اولیه از ۵.۲۱۳۴ بیت به \textbf{۷.۹۹۸۶ بیت} در تصویر رمزشده افزایش یافته و مقدار $\chi^2 = 248.32 < 293.2478$ حاصل شده است \ThesisCite{1}.\par

% SOURCE Entropy_Histogram_Chapter4.txt:13-13 [paragraph]
۲. \textbf{مجموعه‌داده \lr{RITE}:} آنتروپی تصویر اولیه از ۵.۱۸۹۲ بیت به \textbf{۷.۹۹۸۴ بیت} افزایش یافته و مقدار $\chi^2 = 251.15 < 293.2478$ ثبت گردیده است \ThesisCite{1}.\par
...
جدول و نمودار نتایج آزمون‌های ۱۵گانه تصادفی‌سازی استاندارد \lr{NIST SP800{-}22} در شکل ۴{-}۶ نشان داده شده است.\par
...
تحلیل تفصیلی بنچمارک مقایسه‌ای و دستاوردهای روش پیشنهادی در مقایسه با کارهای مرجع نشان می‌دهد که \ThesisCite{1}, \ThesisCite{2}, \ThesisCite{3}, \ThesisCite{5}, \ThesisCite{9}:\par
