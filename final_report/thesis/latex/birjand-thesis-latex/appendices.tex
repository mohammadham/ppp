...
\begin{sourcecode}
\begin{LTR}\ttfamily\fontsize{9}{13}\selectfont\raggedright
\CodeLine{0.0}{def hyperchaos\_\allowbreak{}5d\_\allowbreak{}system(state, alpha=40.0, beta=8.0, gamma=40.0, delta=1.0, epsilon=-0.5, theta=-0.5, rho=25.5, kappa=0.05):}
\CodeLine{2.0}{x, y, z, u, v = state}
\CodeLine{2.0}{dx = alpha * (y {-} x) + u}
\CodeLine{2.0}{dy = gamma * x - x * z + delta * y + v}
\CodeLine{2.0}{dz = x * y - beta * z}
\CodeLine{2.0}{du = -y * z + epsilon * u}
\CodeLine{2.0}{dv = rho * x * z - theta * y - kappa * v}
