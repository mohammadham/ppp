...
در گام سوم، کلید باینری ۲۵۶ بیتی $K_{\mathrm{hash}}$ به ۵ بلوک ۴۸ بیتی مجزا ($K_{b1},\allowbreak{} K_{b2},\allowbreak{} K_{b3},\allowbreak{} K_{b4},\allowbreak{} K_{b5}$) تقسیم شده و از طریق روابط ریاضی مشخص، به ۵ عدد اعشاری پیوسته در بازه $(0,\allowbreak{} 1)$ نرمال‌سازی می‌شوند تا شرایط اولیه $(x_0,\allowbreak{} y_0,\allowbreak{} z_0,\allowbreak{} u_0,\allowbreak{} v_0)$ برای راه‌اندازی دستگاه معادلات دیفرانسیل ۵بعدی ابرآشوبی حاصل گردد. فرمول‌بندی کامل این فرآیند در رابطه ۳{-}۲ ارائه شده است.\par
...
دستگاه معادلات دیفرانسیل حالت پیوسته سیستم ۵ بعدی ابرآشوبی شامل ۵ متغیر حالت \lr{(x, y, z, u, v)} و ۷ پارامتر کنترلی غیرخطی \lr{(a, b, c, d, k, h, w)} به صورت زیر فرمول‌بندی می‌گردد \ThesisCite{1}:\par
