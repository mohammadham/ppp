...
def build():
    ...
    paragraph(d, 'قالب‌ها و شیوه‌نامه‌های دانشگاه آزاد اسلامی که در تهیه این نسخه نیز استناد شده‌اند:')
    paragraph(d, 'پرتال پژوهشی واحد علوم و تحقیقات: https://srb.iau.ir/')
    paragraph(d, 'پرتال پژوهشی واحد کرج: https://karaj.iau.ir/')
    paragraph(d, 'نمونه شیوه‌نامه نگارش پایان‌نامه (PDF): https://www.tmrg.ir/File/Proposal_Form/IAU-Robat-Karim.pdf', rtl=False)
    paragraph(d, 'قالب Word واحد علوم و تحقیقات: https://slidesdoc.ir/iau-science-and-research-branch-thesis/', rtl=False)
