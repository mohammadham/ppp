...
\[\mathcal{F}_{\mathrm{str}} = \mathrm{Format}(\mu_{\mathrm{ROI}}, \text{'.17g'}) \parallel \texttt{|} \parallel \mathrm{Format}(\sigma_{\mathrm{ROI}}^2, \text{'.17g'}) \parallel \texttt{|} \parallel \mathrm{Format}(S_{\mathrm{ROI}}, \text{'.17g'}) \parallel \texttt{|} \parallel \mathrm{Format}(K_{\mathrm{ROI}}, \text{'.17g'}) \parallel \texttt{|} \parallel \mathrm{Str}(W) \parallel \texttt{|} \parallel \mathrm{Str}(H)
\end{equation}
...
دستگاه معادلات دیفرانسیل حالت پیوسته سیستم ۵ بعدی ابرآشوبی خودم autonomous سوباترا و تانیکایسلوَن \cite{Subathra2025} شامل ۵ متغیر حالت $(x, y, z, u, v)$ و پارامترهای کنترلی تثبیت‌شده در پیاده‌سازی محاسباتی به صورت زیر فرمول‌بندی می‌گردد:\par
